...
%     fprintf(fid, ['constBf = ', num2str(Bf_sim_rec), '\n']);
    ...
    fprintf(fid, 'usePcAlphaMixedTerms = No \n');
...
%      fileID = fopen('mp_sim.txt','w'); % uncomment for magnetopause losses
