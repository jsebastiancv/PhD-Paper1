...
for iter = 1 : 3
    ...
    if iter == 1 
        sDate = datenum('01-Oct-2013');
        eDate = datenum('01-May-2014');
    elseif iter == 2
        sDate = datenum('01-May-2014');
        eDate = datenum('01-Jun-2014');
    elseif iter == 3
        sDate = datenum('01-Jun-2014');
        eDate = datenum('01-Oct-2014');
    end
    ...
    if iter == 1
        Flux13_A = Flux13; AlphaEqModel13_A = AlphaEqModel13; Lstar13_A = Lstar13; InvK13_A = InvK13; InvMu13_A = InvMu13; Time13_A = Time13;         
        Flux15_A = Flux15; AlphaEqModel15_A = AlphaEqModel15; Lstar15_A = Lstar15; InvK15_A = InvK15; InvMu15_A = InvMu15; Time15_A = Time15;                  
    elseif iter == 2
%         Flux13_B = Flux15; AlphaEqModel13_B = AlphaEqModel15; Lstar13_B = Lstar15; InvK13_B = InvK15; InvMu13_B = InvMuReal15; Time13_B = Time15;        
    ...
    elseif iter == 3
        Flux13_C = Flux13; AlphaEqModel13_C = AlphaEqModel13; Lstar13_C = Lstar13; InvK13_C = InvK13; InvMu13_C = InvMu13; Time13_C = Time13;        
        Flux15_C = Flux15; AlphaEqModel15_C = AlphaEqModel15; Lstar15_C = Lstar15; InvK15_C = InvK15; InvMu15_C = InvMu15; Time15_C = Time15;                  
    end
