...
%% Plot flux
flux_rean = load('fluxfile_rean.mat');

time = linspace(1,2209,2209);
...
[ax1, cb1] = contourf_flux(time(1:end),L,flux_rean.flux_LT(1:8761,:));
...
set(ax1,'XTick',tticks_month','layer','top');
set(ax1,'XTickLabel',['01-Oct';'01-Nov';'01-Dec';'01-Jan';'01-Feb';'01-Mar';'01-Apr';'01-May';'01-Jun';'01-Jul';'01-Aug';'01-Sep';'01-Oct']) 
...
hold on
title({'Electron flux','3D diffusion + mixed pitch angle - energy diffusion + scattering by EMICs + magnetopause shadowing'},'FontWeight','bold','FontSize',18); 
text(200,4, 'E = 1 MeV, \alpha = 506^o','FontWeight','bold','FontSize',14); 
